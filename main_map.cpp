...
//            std::cout << "b_sig = " << std::bitset<64>(b_sig)  << std::endl;
            ...
            if ((encli_0 >= MAX_ENC_CNT) || (encli_1 >= MAX_ENC_CNT))
            {
                ...
                for (l = 0; l < L; l++) {
                   ...
                   tag = (sig_hash >>((2*K)-tag_size))& tag_mask;  // NISHAT: leftmost (tag) # of bits of sig_hash
                   ...
                   big_sig_hash = sig_hash& big_sig_mask; // NISHAT: righhtmost (2k - tag) # of bits of sig_hash
                   ...
                   if (sigs_indicator_arr[sigs_row_count*l + big_sig_hash]< ((uint64_t)SIGS_COLMN)*partitions) // NISHAT: Er mane holo  hash table er each position e 7 ta kore bucket ache. Check kora hocche je oi position e jayga available kina.
                   {
                        // populate tag array
                        ...
                        if (enc_array_indict == 0 )  // first letter is either A or C
                        {
                            ...
                            sigs_arr[sigs_row_count*((uint64_t)SIGS_COLMN)*partitions*l + big_sig_hash*((uint64_t)SIGS_COLMN)*partitions +
                                     sigs_indicator_arr[sigs_row_count*l + big_sig_hash]]= encli_0; // NISHAT: encli_0 holo
                        ...
                        //=============================================================================
                        // NISHAT: tags_arr er moddhe ache tag. 
                        // NISHAT: Sigs_arr er moddhe thaktese encoding array er pointer. 
                        // NISHAT: Sigs_indicator array te thaktese ekta row er jonne kotoguli column fill up hoise shei count.
                        //=============================================================================
...
//        cout << "Directory created";
    ...
    for (l=0; l < L; l++)
    {
        ...
        // ......BRISTY.....
        total_included_kmers += included_kmers_counter[l];
        ...
        // ... BRISTY .....
        ofstream savekmercount;
        savekmercount.open("kmer_count.txt");
        savekmercount << map_name << " " << total_included_kmers << endl;
        // ... BRISTY .....
